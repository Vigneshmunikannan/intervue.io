...
export default function RoleSelection({ setRole }) {
    ...
    const cardOuterStyle = (role) => ({
        ...
        background: selectedRole === role
            ? 'linear-gradient(to right, #7765DA, #1D68BD)'
            : '#D9D9D9',
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-4 w-full">
            ...
            <div className="flex flex-col items-center">
                <span className="text-[40px] font-light font-sora flex items-center flex-wrap justify-center text-center">
                    Welcome to the
                    <h1 className="ml-[5px] text-[40px] text-purple-600 font-semibold">Live Polling System</h1>
                </span>
            ...
            {/* Cards */}
            <div className="flex justify-center items-center mt-[-50px] ml-[60px]">
                <div className="flex gap-12 flex-wrap justify-center px-4 items-center">
                    {/* Student Card */}
                    <div onClick={() => updateSelectedRole("student")} style={cardOuterStyle("student")}>
                        <div style={cardInnerStyle}>
                            <h2 style={{ fontSize: '23px', fontWeight: 600, lineHeight: '100%' }} className="ml-[50px] mt-[40px]">I’m a Student</h2>
                            <p style={{ fontSize: '16px', fontWeight: 400, lineHeight: '100%', color: '#6B7280' }} className="ml-[50px] mt-[-20px]">
                                Participate in polls and answer in real-time.
                            </p>
                        </div>
                    </div>

                    {/* Teacher Card */}
                    <div onClick={() => updateSelectedRole("teacher")} style={cardOuterStyle("teacher")} className="m-[50px]">
                        <div style={cardInnerStyle}>
                            <h2 style={{ fontSize: '23px', fontWeight: 600, lineHeight: '100%' }} className="ml-[50px] mt-[40px]">I’m a Teacher</h2>
                            <p style={{ fontSize: '16px', fontWeight: 400, lineHeight: '100%', color: '#6B7280' }} className="ml-[50px] mt-[-20px]">
                                Submit questions and monitor live responses.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <button
                ...
                className="bg-gradient-to-r from-[#8F64E1] to-[#1D68BD] text-white text-[18px] font-bold py-2 px-6 rounded-full w-[234px] h-[58px] mt-6 disabled:opacity-50 border-0 text-[#ffffff] cursor-pointer text-center"
            >
                Continue
            </button>
        </div>
