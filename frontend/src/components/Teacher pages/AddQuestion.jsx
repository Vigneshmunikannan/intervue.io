    ...
    return (
        <div>
            <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8 mt-8 text-left ml-[100px] mt-[20px]relative">
                {/* Badge */}
                <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-gradient-to-r from-[#7765DA] to-[#4D0ACD] text-white font-sora font-semibold text-sm h-[31px] w-[134px] ">
